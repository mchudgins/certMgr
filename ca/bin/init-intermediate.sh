...
if [[ ! -e private/intermediate-ca.passphrase.bin ]]; then
  curl -s https://www.fourmilab.ch/cgi-bin/Hotbits?apikey=Pseudorandom\&nbytes=128\&fmt=bin >private/intermediate-ca.passphrase.bin
...
organizationalUnitName = "DST Internal Use Only -- Intermediate CA"
commonName        = "intermediate-ca.dstcorp.io"

...
# this CA is an unconstrained CA (aka it is
# NOT limited to those domains controlled by the firm.)
#
# usage:
#   create-ubu-ca.sh <unit name> <unit tla>
#
# example:
#   create-ubu.ca.sh "Financial Services Group" FSG
#
...
organizationalUnitName = "DST Internal Use Only -- $name Signing CA"
